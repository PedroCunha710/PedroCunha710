...
> _(substitui pelos teus repositórios reais assim que os publicares)_

- 🗄️ **Sistema de Gestão de Reparações Eletrónicas** — modelação de base de dados SQL Server (21 tabelas), camada procedural completa (triggers, stored procedures, views), relatório técnico segundo metodologia Connolly-Begg
- ⚙️ **Knapsack Problem (Java)** — implementação e comparação de algoritmos (Greedy, GRASP, Local Search, Simulated Annealing, Branch & Bound), testado com JUnit 5

---

### 📫 Contacto

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/pedro-cunha-6b89b6354/)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=flat&logo=instagram&logoColor=white)](https://www.instagram.com/pedrocunha725/)
